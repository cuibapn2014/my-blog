...
@section('display')
<div class="col-12">
	<h2 class="fs-3 border-bottom py-2 fw-light">Thêm bài viết</h2>
	<form action="{{route('admin.insert.post')}}" method="post">
		@if(count($errors) > 0)
		...
		<div class="form-check">
			<input class="form-check-input" type="checkbox" checked name="is_publish" value="" id="flexCheckDefault">
